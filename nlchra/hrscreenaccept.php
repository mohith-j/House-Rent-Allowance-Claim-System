...
<body>
	...
	<div class="container borders">
		<ul>
				<li class="col-lg-3"><a href="screen1.php" id="user">User</a></li>
  			    ...
  			    <li class="col-lg-3"><a href="irdepartment1.php">IR Departmem</a></li>
		</ul>
	</div>
	<br>
	<br>
	...
	<div class="container">
		<ul>
			<li width="35%"></li>
			<li width="10%"><a href="hrscreen3.php">User Requests</a></li>
			<li width="10%"><a class="active" href="hrscreenaccept.php">TA Approved</a></li>
	...
	<table class="container centre">
		<thead>
			<tr>
				...
				<td class="col-lg-3 class2"><p>TA Status</p></td>
		...
		$sql = "select * from hra_claim_workflow where current_status='A' and cur_user='T' order by time_stamp";
