...
<body>
	...
	<div class="container">
		<ul>
			...
			<li width="10%"><a class="active" href="hrscreenreject.php">TA Rejected</a></li>
	...
	<table class="container centre">
		...
		$sql = "select * from hra_claim_workflow where current_status='R' and cur_user='T' order by time_stamp";
